  ...
  return (
    ...
    >
      <div className="relative w-full h-full flex items-center justify-center">
        ...
        <div className="absolute bottom-[450px] md:bottom-[350px] flex flex-col items-center">
            <div className='absolute bg-white h-10 sm:max-w-8 md:h-14 animate-revealSlide'></div>
