...
function DevisBtn() {
  return (
   <Link to="/devis" className='group flex w-[250px] justify-between items-center rounded-full pl-5 pr-2 py-2 group-hover:bg-white hover:font-bold duration-700' style={{backgroundColor: mainColors.mainBrown}}>
