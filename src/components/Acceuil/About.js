...
function About() {
  return (
    <section id="about" className='flex flex-col justify-between h-[1150px] px-10 py-20 md:px-72 md:flex-row md:h-[700px]'>
      <div className="h-3/5 flex flex-col justify-between md:w-2/3 md:mr-16 md:h-full">
        <h2 data-aos="fade-up" style={{color: mainColors.mainBrown}}>Explorez notre <span className='font-thin'>univers</span></h2>
          <p data-aos="fade-up" >ENARA Design Agency est une agence d’aménagement 
        ...
        <img data-aos="fade-left" className="md:w-[500px] md:h-h-[700px] mt-10" src='/img/about/int_1.jpg' alt="tableImage"/>
    </section>
  )
}
