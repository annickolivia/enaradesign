...
function Section2() {
  return (
    <section className='px-6 md:px-20 pb-20 pt-20 flex flex-col md:flex-row items-center justify-between h-fit md:h-[550px]'>
        ...
        <p className="text-justify text-lg font-extralight md:w-2/3" data-aos="fade-up">SENSO Design Agency est une agence d’aménagement d’intérieur basée à Madagascar, spécialisée également dans la sous-traitance de modélisation 3D et de visualisation architecturale.
