...
function Section2() {
  return (
    <section className='px-20 py-20 flex flex-col items-center justify-between h-[550px]'>
        ...
        <p className="text-justify text-2xl font-extralight" data-aos="fade-up">ENARA Design Agency est une agence d’aménagement d’intérieur basée à Madagascar, spécialisée également dans la sous-traitance de modélisation 3D et de visualisation architecturale.
