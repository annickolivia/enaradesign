...
function Section5() {
  return (
    <section className='grid grid-cols-[1fr_1.3fr_1.5fr] gap-3 h-[650px] mb-32'>
      ...
      <div className='flex flex-col justify-between text-center px-14 py-10 h-full w-full object-cover' style={{backgroundColor: mainColors.mainBrown}}>
